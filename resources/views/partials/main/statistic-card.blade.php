...
@else
    <div
       class="flex overflow-x-auto snap-x snap-mandatory scrollbar-none sm:grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 min-[1370px]:grid-cols-4 min-[1600px]:grid-cols-6 gap-3 md:gap-6 mb-6 md:mb-8 max-[500px]:no-scrollbar">
        <!-- Всего задач -->
        <div
            class=" bg-white rounded-lg shadow-sm md:shadow-md p-4 md:p-6 card-hover flex flex-col justify-between max-[500px]:items-start max-[500px]:py-2 max-[500px]:w-[calc(45%-6px)] max-[500px]:h-[100px] shrink-0 snap-start">
            <div
                class="flex items-start justify-between mb-3 md:mb-4 max-[500px]:gap-2 max-[500px]:items-center max-[500px]:mb-0">
                <div>
        ...
        <!-- В работе -->
        <div
            class="backdrop-blur-md bg-white rounded-lg shadow-sm md:shadow-md p-4 md:p-6 card-hover flex flex-col justify-between max-[500px]:items-start max-[500px]:py-2 max-[500px]:w-[calc(45%-6px)] max-[500px]:h-[100px] shrink-0 snap-start">
            <div
                class="flex items-start justify-between mb-3 md:mb-4 max-[500px]:gap-2 max-[500px]:items-center max-[500px]:mb-0">
                <div>
