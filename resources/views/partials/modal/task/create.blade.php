    ...
    <div class="bg-white modal-content rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl
        ...
        <div class="sticky top-0 z-10 bg-white/95 backdrop-blur-sm border-b border-gray-100">
            <div class="flex justify-between items-center p-6">
                <div>
                    <h3 class="text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent max-[500px]:text-xl">Новая задача</h3>
                    <p class="text-sm text-gray-500 mt-1 max-[500px]:text-[12px]">Заполните информацию о задаче</p>
                </div>
