        ...
        @if($backgroundEnabled && $backgroundImage)
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12">
                    <!-- Media Card -->
                    <div class="rounded-2xl border-none backdrop-blur-md bg-transparent/20 text-white">
                        <div class="px-4 py-4 sm:pl-6 sm:pr-4 border-none">
                                ...
                                @if($backgroundEnabled && $backgroundImage)
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h4 class="mb-1 text-sm font-medium text-white dark:text-white/90">
                                                    Изображения
                                                </h4>
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center gap-4">
                                            <div
                                                ...
                                                <svg class="stroke-current" width="25" height="24" viewBox="0 0 25 24"
                                                     fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path
                ...
                <div class="col-span-12">
                    <!-- ====== Table Seven Start -->
                    <div
                        class="overflow-hidden rounded-2xl border-none pt-4 backdrop-blur-md bg-transparent/20 text-white">
                        <div class="mb-4 flex items-center justify-between px-6">
                            <div>
                                <h3 class="text-lg font-semibold text-white dark:text-white/90">
                                    Последние файлы
                                </h3>
                            </div>
                        </div>
                                                ...
                                                <div class="flex w-full items-center gap-2 text-sm max-[500px]:justify-start">
                                                    <div>
                                                        @if(str_contains($file->mime_type, 'image'))
                                                            ...
                                                            <img src="{{ asset('images/icons/file-image-dark.svg') }}"
                                                                 alt="icon" class="hidden dark:block">
                                                        @elseif(str_contains($file->mime_type, 'video'))
                                                            <img src="{{ asset('images/icons/file-video.svg') }}"
                                                                 alt="icon" class="dark:hidden">
                                                            <img src="{{ asset('images/icons/file-video-dark.svg') }}"
                                                                 alt="icon" class="hidden dark:block">
                                                        @elseif(str_contains($file->mime_type, 'pdf') || $file->extension == 'pdf')
                                                            <div
                                                                class="w-8 h-8 flex items-center justify-center bg-red-100 dark:bg-gray-800 rounded">
                                                                <span
                                                                    class="text-xs font-medium text-red-500">{{ strtoupper(substr($file->extension, 0, 3)) }}</span>
                                                            </div>
                                                        @else
                                                            <div
                                                    ...
                                                    <a href="{{ route('files.download', $file) }}"
                                                       ...
                                                       title="Скачать">
                                                        <svg class="fill-current" width="20" height="20"
                                                             ...
                                                             xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M13 8V4H7V8H4L10 14L16 8H13ZM4 16H16V18H4V16Z"
                                                                  fill="currentColor"/>
                                                        </svg>
                                                    </a>
                                                       ...
                                                       $file->uploaded_by == Auth::user()->id)
                                                        <form action="{{ route('files.destroy', $file) }}" method="POST"
                                                            ...
                                                            <button type="submit"
                                                                    ...
                                                                    class=" hover:text-red-500 dark:text-gray-400 dark:hover:text-red-400"
                                                                    title="Удалить">
                                                                <svg class="fill-current" width="21" height="20"
