...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8" x-data="photobankApp()" x-init="init()" x-cloak>
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
            <div>
                @if($backgroundEnabled && $backgroundImage)
                    <h2 class="text-3xl font-bold text-white dark:text-white">Фотобанк</h2>
                    <p class="text-white dark:text-gray-400 mt-2" x-text="`${totalPhotos} фотографий`"></p>
                @else
        ...
        <div class="relative">
            <div x-show="loading"
                class="absolute inset-0 bg-white dark:bg-gray-900 bg-opacity-80 flex items-center justify-center z-10 rounded-lg">
